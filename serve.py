...
@app.route("/1/<path:f>")
def p1(f):
  return send_file("/projects/grail/supasorn/" + f);

@app.route("/2nb/<path:f>")
def p2(f):
  return send_file("/projects/grail/supasorn2nb/" + f);

@app.route("/home/<path:f>")
def p3(f):
  return send_file("/homes/grail/supasorn/" + f);
